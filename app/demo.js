...
(function(){
    ...
    angular
        .module('demo', ['azSuggestBox', 'ngAnimate', 'ngSanitize'])
        .controller('demo', ['$scope', '$sce', function($scope, $sce){
            ...
            vm.code1 = hljs.fixMarkup(hljs.highlight('html',
            ...
            vm.code2 = hljs.fixMarkup(hljs.highlight('html',
                '<div az-suggest-box sb-list="vm.cities" sb-selected-list-item-class="sb-list-item-checked" sb-close-list-on-select="true" sb-max-selection="1" class="suggest-box">\r\n'+
                '\t<div sb-trigger-area class="select">\r\n'+
                '\t\t<div class="input">\r\n'+
                '\t\t\t<div sb-selection-item >{{s.name}}</div>\r\n'+
                '\t\t\t<input sb-type-ahead tabindex="2">\r\n'+
                '\t\t</div>\r\n'+
            ...
            vm.code3 = hljs.fixMarkup(hljs.highlight('html',
                '<div az-suggest-box sb-list="vm.statuses" sb-selected-list-item-class="sb-list-item-checked" class="suggest-box">\r\n'+
                '\t<div class="select" sb-trigger-area>\r\n'+
                '\t\t<div class="input">\r\n'+
                '\t\t\t<div sb-selection-item>{{s.name}}\r\n' +
